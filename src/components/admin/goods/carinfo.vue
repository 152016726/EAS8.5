                        ...
                        <tbody>
                            <tr>
                                <th width="48" align="center">
                                    <el-button type="success" @click="Alltoggle">{{toggletxt}}</el-button>
                                </th>
                            ...
                            <tr v-for="(item,index) in list" :key="index">
                                <td :width="48">
                                    <el-switch v-model="istoggle[index]" @change="togglechange"></el-switch>
                                </td>
                                <td align="left">
                                ...
                                <td align="center">
                                    <el-button type="warning" size="mini" @click="delgoods(item.id)">删除</el-button>
                                </td>
                            </tr>
                            <tr>
